...
1. Scompatta la cartella Modal4BibleRefs in `.obsidian/plugins/`
2. Abilita il plugin da Impostazioni → Plugin Comunitari
3. Apri un file markdown con riferimenti biblici `<span class="BibleRef">[[Mt 1,1|Mt 1,1]]</span>`
