...
nomeFile: "_Indice Costituzioni pastorali.md"
creato: 2025/10/26 23:08:38
modificato: 2026/09/01 08:14:29
---


# Indice di tutte le Costituzioni pastorali
...
/*
============================================================
📌 INDICE DINAMICO INTERATTIVO DELLE COSTITUZIONI PASTORALI
============================================================
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const pages = dv.pages(workingFolders)
		...
		.where(p =>
			...
			p["tipo-doc"] && String(p["tipo-doc"]).replace(/[\[\]]/g, "").split("|")[1]?.trim() ==="Costituzione pastorale" &&
			p.file.ext === "md" &&
