...
nomeFile: "_Indice Udienze.md"
creato: 2025/09/16 19:49:34
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Udienze pontificie
...
/*
========================================================
📌 INDICE DINAMICO INTERATTIVO DELLE UDIENZE PONTIFICIE
========================================================
...
nella cartella "Documenti pontifici/Udienze", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Udienze" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Udienze";
