...
# Indice di tutte le Preghiere pontificie
...
/*
=========================================================
📌 INDICE DINAMICO INTERATTIVO DELLE PREGHIERE PONTIFICIE
=========================================================
...
nella cartella "Documenti pontifici/Preghiere", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Preghiere" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Preghiere";
