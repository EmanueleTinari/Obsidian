...
/*
========================================================================
📌 INDICE DINAMICO INTERATTIVO DELLE COSTITUZIONI APOSTOLICHE PONTIFICIE
========================================================================
...
nella cartella "Documenti pontifici/Costituzioni apostoliche", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Costituzioni apostoliche" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Costituzioni apostoliche";
