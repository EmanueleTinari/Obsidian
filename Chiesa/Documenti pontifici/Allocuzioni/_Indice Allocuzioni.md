...
nomeFile: "_Indice Allocuzioni.md"
creato: 2025/11/04 00:00:18
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Allocuzioni pontificie
...
/*
============================================================
📌 INDICE DINAMICO INTERATTIVO DELLE ALLOCUZIONI PONTIFICIE
============================================================
...
nella cartella "Documenti pontifici/Allocuzioni", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Allocuzioni" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Allocuzioni";
