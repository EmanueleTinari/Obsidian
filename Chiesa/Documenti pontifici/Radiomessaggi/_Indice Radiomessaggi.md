...
nomeFile: "_Indice Radiomessaggi.md"
creato: 2025/09/15 23:39:55
modificato: 2026/08/24 21:42:30
---


# Indice di tutti i Radiomessaggi pontifici
...
/*
==========================================================
📌 INDICE DINAMICO INTERATTIVO DEI RADIOMESSAGGI PONTIFICI
==========================================================
...
nella cartella "Documenti pontifici/Radiomessaggi", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Radiomessaggi" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Radiomessaggi";
