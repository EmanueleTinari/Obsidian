...
# Indice di tutte le visite pastorali
...
/*
=====================================================
📌 INDICE DINAMICO INTERATTIVO DELLE VISITE PASTORALI
=====================================================
...
nella cartella "Documenti pontifici/Visite pastorali", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Visite pastorali" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Visite pastorali";
