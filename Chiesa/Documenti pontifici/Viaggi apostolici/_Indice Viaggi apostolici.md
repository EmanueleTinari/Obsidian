...
# Indice di tutti i viaggi apostolici
...
/*
====================================================
📌 INDICE DINAMICO INTERATTIVO DEI VIAGGI APOSTOLICI
====================================================
...
nella cartella "Documenti pontifici/Viaggi apostolici", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Viaggi apostolici" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Viaggi apostolici";
