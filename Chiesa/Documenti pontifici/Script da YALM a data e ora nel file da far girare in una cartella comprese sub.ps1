...
-----------
	...
	6. AMBITO DI ESECUZIONE: analizza i file .md nella cartella corrente e in tutte le sottocartelle.
...
-----------
	...
	6. EXECUTION SCOPE: processes .md files in the current folder and in all subfolders.
