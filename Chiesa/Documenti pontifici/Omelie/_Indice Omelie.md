...
nomeFile: "_Indice Omelie.md"
creato: 2025/09/16 19:49:27
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Omelie pontificie
...
/*
======================================================
📌 INDICE DINAMICO INTERATTIVO DELLE OMELIE PONTIFICIE
======================================================
...
nella cartella "Documenti pontifici/Omelie", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Omelie" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Omelie";
