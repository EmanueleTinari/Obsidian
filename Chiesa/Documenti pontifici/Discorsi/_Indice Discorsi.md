...
nomeFile: "_Indice Discorsi.md"
creato: 2025/09/16 17:31:59
modificato: 2026/08/24 21:42:30
---


# Indice di tutti i Discorsi pontifici
...
/*
====================================================
📌 INDICE DINAMICO INTERATTIVO DEI DISCORSI PONTIFICI
====================================================
...
nella cartella "Documenti pontifici/Discorsi", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Discorsi" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Discorsi";
