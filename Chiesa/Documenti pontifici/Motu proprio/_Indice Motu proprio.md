...
nomeFile: "_Indice Motu proprio.md"
...
/*
=========================================================
📌 INDICE DINAMICO INTERATTIVO DEI MOTU PROPRIO PONTIFICI
=========================================================
...
nella cartella "Documenti pontifici/Motu proprio", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Motu proprio" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Motu proprio";
