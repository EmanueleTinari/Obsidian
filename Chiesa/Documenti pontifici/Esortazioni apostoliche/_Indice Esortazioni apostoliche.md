...
nomeFile: "_Indice Esortazioni apostoliche.md"
creato: 2025/06/16 08:37:29
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Esortazioni apostoliche
...
/*
=============================================================
📌 INDICE DINAMICO INTERATTIVO DELLE ESORTAZIONI APOSTOLICHE
=============================================================
...
nella cartella "Documenti pontifici/Esortazioni apostoliche", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Esortazioni apostoliche" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Esortazioni apostoliche";
