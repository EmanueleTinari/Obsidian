...
nomeFile: "_Indice Angelus.md"
creato: 2025/09/15 23:39:55
modificato: 2026/08/24 21:42:30
---


# Indice di tutti gli Angelus pontifici
...
/*
=======================================================
📌 INDICE DINAMICO INTERATTIVO DEGLI ANGELUS PONTIFICI
=======================================================
...
nella cartella "Documenti pontifici/Angelus", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Angelus" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Angelus";
