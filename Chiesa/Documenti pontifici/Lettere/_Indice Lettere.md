...
nomeFile: "_Indice Lettere.md"
creato: 2025/09/16 19:51:30
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Lettere pontificie
...
/*
=======================================================
📌 INDICE DINAMICO INTERATTIVO DELLE LETTERE PONTIFICIE
=======================================================
...
nella cartella "Documenti pontifici/Lettere", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Lettere" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Lettere";
