...
nomeFile: "_Indice Bolle.md"
creato: 2025/05/03 16:49:10
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Bolle pontificie
...
/*
=====================================================
📌 INDICE DINAMICO INTERATTIVO DELLE BOLLE PONTIFICIE
=====================================================
...
nella cartella "Documenti pontifici/Bolle", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Bolle" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Bolle";
