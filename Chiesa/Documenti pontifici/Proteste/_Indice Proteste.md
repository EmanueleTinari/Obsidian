...
nomeFile: "_Indice Proteste.md"
creato: 2025/10/26 21:37:11
modificato: 2026/09/01 08:14:29
---


# Indice di tutte le Proteste pontificie
...
/*
========================================================
📌 INDICE DINAMICO INTERATTIVO DELLE PROTESTE PONTIFICIE
========================================================
...
nella cartella "Documenti pontifici/Proteste", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Proteste" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Proteste";
