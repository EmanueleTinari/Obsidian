...
nomeFile: "_Indice Editti.md"
creato: 2025/10/26 21:16:52
modificato: 2026/08/24 21:42:30
---


# Indice di tutti gli Editti pontifici
...
/*
====================================================
📌 INDICE DINAMICO INTERATTIVO DEGLI EDITTI PONTIFICI
====================================================
...
nella cartella "Documenti pontifici/Editti", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Editti" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Editti";
