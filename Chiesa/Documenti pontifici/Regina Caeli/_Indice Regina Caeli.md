...
nomeFile: "_Indice Regina Caeli.md"
creato: 2025/09/23 22:42:08
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Regina Caeli pontificie
...
/*
============================================================
📌 INDICE DINAMICO INTERATTIVO DELLE REGINA CAELI PONTIFICIE
============================================================
...
nella cartella "Documenti pontifici/Regina Caeli", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Regina Caeli" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Regina Caeli";
