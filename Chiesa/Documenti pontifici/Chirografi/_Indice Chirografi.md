...
nomeFile: "_Indice Chirografi.md"
creato: 2025/09/15 23:39:55
modificato: 2026/08/24 21:42:30
---


# Indice di tutti i Chirografi pontifici
...
/*
=======================================================
📌 INDICE DINAMICO INTERATTIVO DEI CHIROGRAFI PONTIFICI
=======================================================
...
nella cartella "Documenti pontifici/Chirografi", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Chirografi" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Chirografi";
