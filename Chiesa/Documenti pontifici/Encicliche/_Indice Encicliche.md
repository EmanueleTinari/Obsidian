...
nomeFile: "_Indice Encicliche.md"
creato: 2025/05/03 17:11:52
modificato: 2026/08/24 21:42:30
---


# Indice di tutte le Encicliche pontificie
...
/*
==========================================================
📌 INDICE DINAMICO INTERATTIVO DELLE ENCICLICHE PONTIFICIE
==========================================================
...
nella cartella "Documenti pontifici/Encicliche", escludendo tutti i file che iniziano per "_".
...
"Documenti pontifici/Encicliche" folder, excluding all files starting with "_".
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const workingFolder = "Documenti pontifici/Encicliche";
