...
nomeFile: "_Indice Costituzioni.md"
creato: 2025/10/26 23:08:38
modificato: 2026/09/01 08:14:29
---


# Indice di tutte le Costituzioni
...
/*
==================================================
📌 INDICE DINAMICO INTERATTIVO DELLE COSTITUZIONI
==================================================
...
tipo-doc "Costituzione" presenti nelle cartelle "Documenti pontifici" e 
...
tipo-doc "Costituzione" located across the "Documenti pontifici" and 
...
// [ENG] Opens an isolated code block (scope) to prevent variable conflicts on every note reload.
{
	...
	const pages = dv.pages(workingFolders)
		...
		.where(p =>
			...
			p["tipo-doc"] && String(p["tipo-doc"]).replace(/[\[\]]/g, "").split("|")[1]?.trim() === "Costituzione" &&
			p.file.ext === "md" &&
