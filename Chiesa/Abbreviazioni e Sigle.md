...
creato: 2026/03/14 01:00:18
modificato: 2026/08/21 19:43:10
---


NOTA BENE:
1. Questa nota all'apparenza vuota, serve solo ed unicamente unita al plugin
	- [Abbreviations and Acronyms](https://github.com/dragonish/obsidian-abbreviations)
	- di [dragonish](https://github.com/dragonish);
2. Editare la lista delle abbreviazioni e degli acronimi con un editor di testo
	- [Notepad++](https://notepad-plus-plus.org/),
	- [Microsoft Visual Studio Code](https://code.visualstudio.com/),
	- [PyCharm](https://www.jetbrains.com/pycharm/)
	- o in modalità Modifica (Edit) di ObsidianMD.
